      ...
      <div class="d-flex flex-column w-100">
        ...
        <div class="d-flex flex-row w-100 justify-content-around py-3 pb-5 align-items-center p-2">
          ...
          <div class="d-flex flex-row justify-content-center col-8 col-lg-6 col-xl-6">
            <button v-for="(item,k1) in lastpage" @click="setPage(item)" :key="k1" :class="'mx-2 d-flex justify-content-center align-items-center btn btn-sm py-2 text-white rounded-pill page-item'+(currentpage==item?' bg-main-blue':' bg-dark-blue')">
