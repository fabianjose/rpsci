<template>
    <div class="main-middle" >
        <div class="main-search-form py-3 px-1 mt-3 row" >
            <div class="d-flex flex-row flex-wrap col mx-auto justify-content-center">
               
               
                <div class=" form-group custom-control custom-radio col-2" @click="offerType='private';" >
                ...
                <div class=" form-group custom-control custom-radio col-2" @click="offerType='company';" >
                ...
                <div class="form-group has-search ci-select-container col-2">
                ...
                <div class="form-group has-search col-2">
                ...
                <div class="form-group has-search col-3">
                ...
                <div class="form-group col-1" @click="search" >
